...
// 为新到顾客确定最佳队列
int best_window(pyincpp::Deque<Customer> windows[], int win_num)
{
...
{
    pyincpp::Deque<Customer>* windows = new pyincpp::Deque<Customer>[win_num]; // 为每一窗口创建一个队列
